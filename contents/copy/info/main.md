...
CSSconf EU will take place on May 31st, 2019 in [Berlin’s Arena Halle](https://www.google.de/maps/place/Arena+Berlin/@52.4966473,13.4530078,15z/data=!4m2!3m1!1s0x0:0x6852fd9350063186?sa=X&ved=0ahUKEwjP5-7ntezYAhWBDOwKHekCBFcQ_BIIigEwCg), offering a day packed with inspiring and insightful talks and time well spent in the company of great people. Building on our experiences from previous years we’re planning on using the big venue even more and present you a wonderful CSSconf EU Festival full of surprises.
...
Talks are always in English, and video recordings will be released for free after the event. All speakers are selected via an open [Call for Speakers](/call-for-speakers). <!-- [See the full line-up here](/speakers). -->
...
Berlin has two airports, both of which are located close to the city center, a 30-minute taxi ride from the venue (ca. EUR 35). There are also trains and buses that connect the airports to Berlin’s city center.
...
Berlin’s flat geography, its many [bike lanes](https://en.wikipedia.org/wiki/Cycling_in_Berlin) and the [friendly weather in late May](http://www.yr.no/place/Germany/Berlin/Berlin/statistics.html) make it perfect to get around by bike! Check with your hotel or hostel if they have bikes to rent out, or find your perfect bike at one of the many [bike rental places](https://www.yelp.com/search?find_desc=bike+rental&find_loc=Berlin&start=0&cflt=bikerentals).
...
Below are a two hotels we recommend, both a 20 minute walk away from our venue. If neither of those fit your needs, check out [HRS](http://www.hrs.com/), [booking.com](https://www.booking.com), or private accommodation options like [AirBnB](https://www.airbnb.de/) or [Couchsurfing](https://www.couchsurfing.com/).

* [nhow (20 min walk)](https://www.nhow-berlin.com/en/)
* [Michelberger Hotel (20 min walk)](http://michelbergerhotel.com/en/)

If you’d like to team up with other attendees to travel to or stay in Berlin, let us and the community know on Twitter: [#cssconfeu](https://twitter.com/search?q=%23cssconfeu) – we will help spread the word!
